...
# Basic configuration
bs = 12
saved_model = './saved_model/convlstm'
best_checkpoint = './saved_model/convlstm_best'
figure_path = './figure/'
...
trainset_loader = data_io.RawDataGenerator(batch_size=bs, time=1)
validset_loader = data_io.RawDataGenerator(batch_size=bs, time=1, mode='valid')

# Training network

print("Training for a new UNet model:")

model = network.convlstm(img_shape=(901, 1, 128, 1))
...
plt.savefig(figure_path + '/convlstm - Model loss.jpg')
